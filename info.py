...
BOT_TOKEN = environ.get('BOT_TOKEN', "7879303252:AAEXBWkO3GujnD_Z6IALvVCmYuxYJIs9Dq8")
...
SPELL_IMG = environ.get("SPELL_IMG", "https://envs.sh/s/XyltYeXHVHKbeIO-Irkpcw/pe7.jpg")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002294863108 -1002386306695').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002345510042') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002356190631')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://razith786:Tk3e5UV85Jt8jypE@cluster0.pk5zp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Type_And_Get_Movie_24_7')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/All_In_One_Linkz')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'chat_sup_6') # Support Chat Link Without https:// or @
...
MSG_ALRT = environ.get('MSG_ALRT', 'What are Doing ?')
